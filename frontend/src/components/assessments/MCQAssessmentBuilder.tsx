...
import { Plus, Edit2, Trash2, Loader2, CheckCircle } from 'lucide-react';
...
function MCQQuestionModal({ assessmentId, question, onClose, onSuccess }: MCQQuestionModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const questionData: any = { ...formData };
      if (!questionData.topic) delete questionData.topic;
      if (!questionData.difficulty) delete questionData.difficulty;

      if (question) {
        await api.put(`/assessments/mcq-questions/${question.id}`, questionData);
      } else {
        await api.post(`/assessments/${assessmentId}/mcq-questions`, questionData);
      }
